...
O AWS Certified Solutions Architect - Professional é destinado a indivíduos com dois ou mais anos de experiência prática em design e implantação de arquitetura em nuvem na AWS. Antes de fazer este exame, recomendamos que você tenha:
- Familiaridade com AWS CLI, APIs AWS, modelos AWS CloudFormation, console de faturamento AWS, console de gerenciamento AWS, linguagem de script e ambientes Windows e Linux
- Capacidade de fornecer orientação de melhores práticas sobre design de arquitetura em várias aplicações e projetos da empresa, bem como a capacidade de mapear objetivos de negócios para requisitos de aplicação/arquitetura
- Capacidade de avaliar requisitos de aplicação em nuvem e fazer recomendações arquitetônicas para implementação, implantação e provisionamento de aplicações na AWS
- Capacidade de projetar uma arquitetura híbrida usando tecnologias-chave da AWS (por exemplo, VPN, AWS Direct Connect) e um processo contínuo de integração e implantação

## Preparação

- Guia Oficial do Exame: [https://d1.awsstatic.com/training-and-certification/docs-sa-pro/AWS-Certified-Solutions-Architect-Professional_Exam-Guide.pdf](https://d1.awsstatic.com/training-and-certification/docs-sa-pro/AWS-Certified-Solutions-Architect-Professional_Exam-Guide.pdf)

- O exame pode conter dois tipos de perguntas:
    - Múltipla escolha
    - Múltiplas respostas

- Pontuação mínima de aprovação: 750/1000
- Número de perguntas: 75
- Tempo: 190 minutos para completar o exame (com possibilidade de solicitar 30 minutos adicionais para falantes não nativos de inglês)

## Créditos

- Estas notas são baseadas no curso [AWS Certified Solutions Architect - Professional](https://learn.cantrill.io/p/aws-certified-solutions-architect-professional) de Adrian Cantrill e em [Ultimate AWS Certified Solutions Architect Professional 2021](https://www.udemy.com/course/aws-solutions-architect-professional/) de Stephane Maarek
- Todas as imagens presentes nas notas são retiradas do repositório [GitHub](https://github.com/Ernyoke/aws-sa-pro) de Adrian Cantrill para seu curso
